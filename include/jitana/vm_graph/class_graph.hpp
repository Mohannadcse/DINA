...
struct class_graph_property {
	std::unordered_map<jvm_type_hdl, class_vertex_descriptor> jvm_hdl_to_vertex;
...
inline boost::optional<class_vertex_descriptor> lookup_class_vertex(
		const dex_type_hdl& hdl, const ClassGraph& g) {
...
template<typename ClassGraph>
inline boost::optional<class_vertex_descriptor> lookup_class_vertex(
		const jvm_type_hdl& hdl, const ClassGraph& g) {
...
/*Reana*/
//struct class_super_edge_property_reana {
//};
//inline void print_graphviz_attr_reana(std::ostream& os,
//		const class_super_edge_property_reana& prop) {
...
inline bool is_superclass_of(const class_vertex_descriptor& superclass,
		const class_vertex_descriptor& subclass, const ClassGraph& g) {
