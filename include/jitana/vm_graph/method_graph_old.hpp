...
namespace jitana {
    ...
    /*Reana*/
//    struct method_super_edge_property_reana
//	{
//    };
//
//    struct method_reflection_edge_property
//    {
//    };
//
//    inline void print_graphviz_attr_reana(std::ostream& os,
//    		const method_reflection_edge_property& prop)
//    {
//    	os << "dir=both, arrowhead=none, arrowtail=empty, color=purple";
//    }
//
//    inline void print_graphviz_attr_reana(std::ostream& os,
//    		const method_super_edge_property_reana& prop)
//    {
